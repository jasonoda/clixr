  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: 'src/wallPapers_mobile.html', to: 'wallPapers_mobile.html' },
        { from: 'src/purse.html', to: 'purse.html' },
        { from: 'src/opener.html', to: 'opener.html' },
        { from: 'src/dispenser.html', to: 'dispenser.html' },
